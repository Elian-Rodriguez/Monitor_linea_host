...
cur.execute( """ SELECT * FROM Kardex_monitor.Conf_pos; """ )
...
for shop in datos:
    ...
    COD_POS= shop[0]
    Clave=shop[2]
    COMANDO =COMANDO + "\nsudo sshpass  -f "+Clave+" ssh -o StrictHostKeyChecking=no root@"+IP+"""  "grep description /home/reg/gd90/jpos.xml | grep rinter"  > """+COD_POS+""".txt; """
